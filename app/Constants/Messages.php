...
class Messages
{
    ...
    public const string SUPPLIERS_FETCHED_SUCCESS = 'Suppliers fetched successfully.';

    public const string ERROR_FETCHING_SUPPLIERS = 'Failed to fetch suppliers.';

    public const string SUPPLIER_UPDATED_SUCCESS = 'Supplier updated successfully.';

    public const string ERROR_UPDATING_SUPPLIER = 'An error occurred while updating the supplier.';
